...
Das Skript das im Zuge der Automatisierung verwendet wird, ist im Unterverzeichnis \enqoute{crosscorrelation} unter \enquote{automated\_crosscorrelation.py} zu finden.
