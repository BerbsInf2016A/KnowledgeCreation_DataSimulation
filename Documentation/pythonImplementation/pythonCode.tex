\chapter{Implementierung des Analyseprojekts}
...
\section{Benennung der erzeugten Dateien}
...
\lstnewenvironment{MetadataExample}
{\lstset{
		captionpos=b,
		frame=single,
		label={lst:metadata},
		caption={Quelldatei mit Sequenzen (mit und ohne Metadaten)},
		showspaces=false,
		showtabs=false,
		breaklines=true,
		showstringspaces=false,
